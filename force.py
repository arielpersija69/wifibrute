...
def banner():
    ...
    time.sleep(1.5)
    print GG+"  ======================================="
    print GL+"  ••••••   BRUTE FORCE WI-FI.   ••••••"
    print GG+"  ======================================="
    print GL+"              Baca Bismillah Dulu yaaa"
    print Y+"♦ Created : Ariel Sandy Permana"
    print Y+"♦ Team : GARUDA ERROR SYSTEM"
    print Y+"♦ Github : https://github.com/arielpersija69"
    print Y+"♦ YouTube : Ariel 69 Channel"
    print GG+"  ======================================="

banner ()

email_target = str(raw_input(GL+"\033[92mMasukkan Wifi Target =>\033[93m  "))
